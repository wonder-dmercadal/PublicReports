...
1. **Perda de conhecimento crítico:** Aposentadoria de profissionais experientes e alta rotatividade pos pandemia
...
```mermaid
pie
    title Distribuição de Gastos com Tecnologia no Setor de O&G
    "E&P" : 38
    "Perfuração" : 12
    "FPSO" : 24
    "Refino" : 18
...
Com base na análise, focaremos em vendas diretas em vez de parcerias com consultorias:
